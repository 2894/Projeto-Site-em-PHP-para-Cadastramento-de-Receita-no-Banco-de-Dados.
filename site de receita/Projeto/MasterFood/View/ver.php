    ...
    if ($cod) {
        ...
        if ($receita != null) {
            ...
            <ul>
                ...
                <li class="break"><?= $receita->getTitulo(); ?> - <?= $receita->getData(); ?></li>
                ...
                <li class="text">
                    <a href="?pagina=novo&cod=<?= $receita->getCod(); ?>" class="waves-effect red accent-1 accent-3 btn">Editar receita</a>
                </li>
